...
<!-- avatar placeholder: ![Jan Domański](/docs/images/avatar.png){: .avatar } — re-enable with a small .avatar rule in _sass/minima/custom-styles.scss when redesigning the homepage -->
...
From 2017 to 2021, I have been a co-founder and CTO at Labstep. Labstep set out to make scientists more productive and creative, by providing a best-in-class electronic notebook experience [www.labstep.com](https://www.labstep.com).
